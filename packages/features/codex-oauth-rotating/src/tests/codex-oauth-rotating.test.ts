...
describe("Codex rotating auth domain", () => {
  it("recognizes only the reserved certified-fork v6 schema", () => {
    expect(isCertifiedForkCodexWorkflowSchemaVersion(CodexRotatingT0WorkflowSchemaVersion.CertifiedForkReviewV6)).toBe(true);
    expect(isCertifiedForkCodexWorkflowSchemaVersion(99)).toBe(false);
    expect(isCertifiedForkCodexWorkflowSchemaVersion(CodexRotatingT0WorkflowSchemaVersion.VersionedSecretNamespaceV5)).toBe(false);
    expect(isVersionedSecretNamespaceCodexWorkflowSchemaVersion(CodexRotatingT0WorkflowSchemaVersion.VersionedSecretNamespaceV5)).toBe(true);
    expect(isVersionedSecretNamespaceCodexWorkflowSchemaVersion(CodexRotatingT0WorkflowSchemaVersion.CertifiedForkReviewV6)).toBe(false);
