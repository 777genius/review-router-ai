export function safeDashboardErrorCode(error: unknown): string {
  ...
  if (
    [
      ...
      "hosted_pool_device_login_expired",
      "hosted_pool_device_login_denied",
      "hosted_pool_device_login_artifact_invalid",
      "hosted_pool_device_login_provider_unavailable",
      "hosted_pool_device_login_failed",
