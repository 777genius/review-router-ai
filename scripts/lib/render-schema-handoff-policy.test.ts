  ...
  it("pins checkout102 to actual SQL103 bytes and the complete manifest", () => {
    ...
    expect(
      createHash("sha256")
        ...
        .digest("hex"),
    ).toBe("384f390ef5ba48ad314688fa78d6fe3d2ee64d6746c92e4c1469798cd0ca9b9c");
...
describe("complete filesystem checkout inventory", () => {
  ...
  it("reads checkout101/100/99/98/97, historical96/95 and original92 as identical frozen92 rows", async () => {
